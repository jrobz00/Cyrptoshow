        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <header className="mb-4 flex items-center justify-between py-4 md:py-8">
            ...
            <div className="flex">
              ...
              <nav className="hidden gap-12 lg:flex items-center">
                ...
                <Button text="Sign in" href="#"></Button>
              </nav>
              {/* nav - end */}
          ...
          <div className=" py-6 sm:py-8 lg:py-12">
            <div className="max-w-screen-2xl">
              <div className="flex max-w-xl flex-col items-center text-start">
                <h1 className="mb-8 text-5xl font-semibold text-black sm:text-4xl md:mb-12 md:text-5xl tracking-[0.2rem] leading-tight">
                  First Impressions Count
                </h1>

                <div className="flex w-full flex-col gap-2.5 md:flex-row  md:justify-start ">
                  <Button text="How we can help" href="#"></Button>
                </div>
              </div>
            </div>
          </div>

          {/* headline & button - start
          ...
          {/* <section className="min-h-96 relative flex flex-1 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-gray-100 py-16 shadow-lg md:py-20 xl:py-48"></section> */}
        </div>
      </div>
      {/* hero - end */}
