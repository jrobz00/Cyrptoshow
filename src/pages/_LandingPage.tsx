      ...
      <section className="mx-auto max-w-screen-2xl px-4 md:px-8 ">
        ...
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
          ...
          <div className="flex items-center justify-center gap-4 lg:justify-start">
            <span className="text-sm font-semibold uppercase tracking-widest text-custom-purple sm:text-base">
              Social
            </span>
            ...
            <div className="flex gap-4">
              <Link
                href="/ComingSoon"
                target="_blank"
                className="text-custom-purple transition duration-100 hover:text-gray-500 active:text-gray-600"
              >
                <svg
                  className="h-5 w-5"
                  width="24"
        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <div className="mb-10 md:mb-16">
            ...
            <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
              At BrandLift, we harness the power of AI-driven strategies to
              transform your brand, ensuring a seamless journey towards success.
            </p>
          </div>
          {/* <!-- text - end --> */}
          ...
          <div className="grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16">
            {/* <!-- feature - start --> */}
            <Feature
              headline="Increased Visibility"
              body="Stand out and attract more customers."
              icon={<VisibilityIcon />}
              className=""
            ></Feature>
            <Feature
              headline="Drive Growth"
              body="Lay the foundation for long-term success."
              icon={<TrendingUpIcon />}
              className=""
            ></Feature>
            <Feature
              headline="Improve Perception"
              body="Enhance how your brand is perceived."
              icon={<FaceIcon />}
              className=""
            ></Feature>
            <Feature
              headline="Competitive Edge"
              body="Differentiate yourself from competitors."
              icon={<VolcanoIcon />}
              className=""
            ></Feature>
            <Feature
              headline="Stay Relevant"
              body="Adapt to changing market preferences."
              icon={<EmojiPeopleIcon />}
              className=""
            ></Feature>
            <Feature
              headline="Brand Consistency"
              body="Inforces brand consistency across all channels"
